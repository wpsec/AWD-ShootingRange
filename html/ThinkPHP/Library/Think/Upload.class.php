...
class Upload
{
    ...
    private $config = array(
        'mimes' => array("image/jpeg","image/gif","image/png","image/jpeg","application/zip","application/octet-stream","application/x-tar","application/x-gzip","application/x-7z-compressed","application/msword","application/vnd.openxmlformats-officedocument.wordprocessingml.document","text/plain","application/xml"), //允许上传的文件MiMe类型
