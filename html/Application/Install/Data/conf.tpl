...
'mimes' => 'image/jpeg,image/gif,image/png,image/jpeg,application/zip,application/octet-stream,application/x-tar,application/x-gzip,application/x-7z-compressed,application/msword,application/vnd.openxmlformats-officedocument.wordprocessingml.document,text/plain,application/xml,application/x-zip-compressed', //允许上传的文件MiMe类型
...
'mimes'    => "image/jpeg,image/gif,image/png,image/jpeg", //允许上传的文件MiMe类型
'maxSize'  => 200*1024*1024, //上传的文件大小限制 (0-不做限制)
