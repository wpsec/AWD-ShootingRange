...
(14, 'SyncLogin', '同步登录', '同步登录', 1, '{"type":null,"meta":"","bind":"0","QqKEY":"","QqSecret":"","SinaKEY":"","SinaSecret":"","WeixinKEY":"","WeixinSecret":""}', 'xjw129xjt', '0.1', 1432792112, 0);
...
(217, 'admin', 1, 'Admin/Forum/forum', '版块管理', -1, ''),
...
(240, 'admin', 1, 'Admin/Forum/forumTrash', '版块回收站', -1, ''),
...
(1001, '_CONFIG_WEB_SITE_NAME', 0, '', 0, '', '', 1427339647, 1427339647, 1, 'OpenSNS v5开源社群系统', 0),
(1002, '_CONFIG_ICP', 0, '', 0, '', '', 1427339647, 1427339647, 1, '浙ICP备12042711号-5', 0),
(1003, '_CONFIG_LOGO', 0, '', 0, '', '', 1427339647, 1427339647, 1, '', 0),
(1004, '_CONFIG_QRCODE', 0, '', 0, '', '', 1427339647, 1427339647, 1, '', 0),
(1005, '_CONFIG_ABOUT_US', 0, '', 0, '', '', 1427339647, 1427339647, 1, '<p>&nbsp; 嘉兴想天信息科技有限公司专注于为客户提供专业的社群方案。公司秉持简洁、高效、创新，不断为客户创造奇迹。旗下产品有OpenSNS开源社群系统和OpenCenter开源用户和后台管理系统。</p>', 0),
...
(1007, '_CONFIG_COPY_RIGHT', 0, '', 0, '', '', 1427339647, 1427339647, 1, '<p>Copyright ©2014-2017 <a href="http://www.ourstu.com" target="_blank">嘉兴想天信息科技有限公司</a></p>', 0),
...
(1020, '_CONFIG_COMPANY', 0, '', 0, '', '', 1427339647, 1427339647, 1, '<a href="http://www.ourstu.com/joinus.html" target="_blank"><p><i class="icon icon-user"></i>加入我们</p></a><p><i class="icon icon-phone-sign"></i>400-0573-080</p><p><i class="icon icon-envelope-alt"></i>co@ourstu.com</p>', 0),
...
(50, 'syncLogin', '第三方登录位置', 1, 1403700579, 'SyncLogin'),
(51, 'syncMeta', '第三方登录meta接口', 1, 1403700633, 'SyncLogin'),
...
INSERT INTO `ocenter_invite` (`invite_type`, `code`, `uid`, `can_num`, `already_num`, `end_time`, `status`, `create_time`) VALUES
(1, 'M9TR2PPaHWY', 1, 100000, 0, 1818494575, 1, 1502961774);
...
INSERT INTO `ocenter_module` (`id`, `name`, `alias`, `version`, `is_com`, `show_nav`, `summary`, `developer`, `website`, `entry`, `is_setup`, `sort`, `icon`, `can_uninstall`, `admin_entry`,`menu_hide`) VALUES
...
CREATE TABLE IF NOT EXISTS `ocenter_super_links` (
  ...
  PRIMARY KEY (`id`)
) ENGINE=MyISAM  DEFAULT CHARSET=utf8 ROW_FORMAT=DYNAMIC COMMENT='友情连接表' AUTO_INCREMENT=3 ;
INSERT INTO `ocenter_super_links` (`id`, `type`, `title`, `cover_id`, `link`, `level`, `status`, `create_time`) VALUES
(1, 2, '嘉兴想天', 0, 'http://www.ourstu.com', 0, 1, 1471424712),
(2, 2, 'OpenSNS', 0, 'http://www.opensns.cn', 0, 1, 1471424736);
...
CREATE TABLE IF NOT EXISTS `ocenter_ucenter_short` (
  ...
  `update_time` int(11) NOT NULL,
  PRIMARY KEY (`id`)
) ENGINE=MyISAM DEFAULT CHARSET=utf8 COMMENT='用户个性域名' AUTO_INCREMENT=1 ;
...
CREATE TABLE IF NOT EXISTS `ocenter_attest_type` (
  ...
  PRIMARY KEY (`id`)
) ENGINE=MyISAM  DEFAULT CHARSET=utf8 COMMENT='认证类型' AUTO_INCREMENT=4 ;
...
CREATE TABLE IF NOT EXISTS `ocenter_message_template` (
  ...
  `weixin` text CHARACTER SET utf8 NOT NULL COMMENT '微信公众号消息模板',
